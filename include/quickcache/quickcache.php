...
$includedir     = "/var/www/agdash/include/quickcache";

/* File based caching setting. */
$QUICKCACHE_DIR = $includedir . '/var/www/agdash/cache';
...
$QUICKCACHE_DB_DATABASE = 'agilysys'; // Database-name to use
$QUICKCACHE_DB_USERNAME = 'user';           // Username
$QUICKCACHE_DB_PASSWORD = 'password';           // Password
...
$QUICKCACHE_TIME         =   150; // Default number of seconds to cache a page
...
$QUICKCACHE_POST         =   1;   // Should POST's be cached (default OFF)
