...
define('LANG_JAVASCRIPT_GROUP2', 'использовать заголовок страницы (<a href="http://www.labsmedia.com/clickheat/performance.html" onclick="window.open(this.href, \'external\');return false">не рекомендуется</a>)');
define('LANG_JAVASCRIPT_GROUP3', 'использовать адрес страницы (<a href="http://www.labsmedia.com/clickheat/performance.html" onclick="window.open(this.href, \'external\');return false">не рекомендуется</a>)');
...
define('LANG_CONFIG_MEMORY', 'Лимит памяти (по умолчанию в php.ini установлено: %dМБ, в пределах от %dМБ до %dМБ, но <a href="http://www.labsmedia.com/clickheat/performance.html" onclick="window.open(this.href, \'external\');return false">будьте осторожны с большими значениями</a>)');
