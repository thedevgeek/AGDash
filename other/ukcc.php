...
// Query Database
$result = mysql_query("SELECT * FROM employees WHERE dept='UK POS' ORDER BY `tickets` DESC") or die('Query failed: ' . mysql_error());
...
{
$i++;
//	echo "<tr><td align=left>" . $row[2] . "</td><td align=right>" . $row[3] . "</td></tr>\n";
if ($row[3] < 1) {
	// do nothing
} else {
